  ...
  <body>
	...
	<section>
		<div class="content text-center">
			<div class="container">
				<h1 class="display-4 black contact-title">Ошибка</h1>
				<div class="row justify-content-center">
					<div class="col-md-6">
						<p class="error-p">Неправильное имя пользователя!</p><br/>
						<a href='login.php' class='btn btn-primary back-button'> Назад </a>
					</div>
					</div>
				</div>
			</div>
