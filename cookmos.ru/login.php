  ...
  <body>
	...
	<?php 
		...
		if (isset($_POST['username']) and isset($_POST['password'])) {					
            ...
            else if ($user != $_POST['username']) {
                header("Location: error_u.php");
            }
			else if ($user == $_POST['username'] && $pass != md5($_POST['password'])) {
				header("Location: error_p.php");
			}
        }
		}
		if (isset($_SESSION['username']) && $_POST['username'] != 'admin') {
			$username = $_SESSION['username'];
			header("Location: lc.php");
		}
		else if (isset($_SESSION['username']) && $_POST['username'] == 'admin') {
			$username = $_SESSION['username'];
